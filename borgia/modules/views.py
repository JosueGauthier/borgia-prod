...
class ShopModuleSaleView(ShopModuleMixin, BorgiaFormView):
    ...
    def form_valid(self, form):
        ...
        if self.module_class == "self_sales":
            ...
            # :::
            client = form.cleaned_data['client'] #le mdp a déjà été check par le formulaire (si la fonctionnalité est activée)
        else:
            self.handle_unexpected_module_class()
        ...
        for field in form.cleaned_data:
            ...
            # :::
            if field not in  ['client', 'password'] and form.cleaned_data[field] != '':
...
class ShopModuleConfigUpdateView(ShopModuleMixin, BorgiaFormView):
    ...
    def get_initial(self):
        ...
        # :::
        if self.module.get_module_class() == 'operator_sales':
            initial['ask_password'] =  self.module.ask_password
        return initial
    ...
    def form_valid(self, form):
        ...
        if self.module.get_module_class() == 'operator_sales':
            self.module.ask_password = form.cleaned_data['ask_password']
